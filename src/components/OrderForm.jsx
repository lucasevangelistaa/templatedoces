    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full p-2 border border-gray-300 rounded-md"
          rows={3}
          placeholder="Ex: Doces em embalagens separadas, sem nozes, etc."
        />
      </div>

      <button
        type="submit"
        className="w-full bg-[#C2A370] text-[#FAF8F6] py-3 rounded-md font-bold hover:bg-[#c2a370af] transition-colors"
      >
